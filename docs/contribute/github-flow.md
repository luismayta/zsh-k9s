<!-- Space: Projects -->
<!-- Parent: ZshK9s -->
<!-- Title: Contributing GithubFlow ZshK9s -->
<!-- Label: ZshK9s -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-k9s project on [GitHub](https://github.com/hadenlabs/zsh-k9s), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-k9s/pulls).
...
To follow the instructions in this guide and start contributing to zsh-k9s project on GitHub:
